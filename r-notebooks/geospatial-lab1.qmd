...
## Read in points from a csv file

```{r}
fil <- file.path("/home", "jovyan", "shared", "2023-Hackbook", "r-notebooks", "data", "india_tide_guages.csv")
df2 <- readr::read_csv(fil)
```
...
```{r}
fil <- file.path("/home", "jovyan", "shared", "2023-Hackbook", "r-notebooks", "data", "india_tide_guages.xlsx")
...
Here is another way to add point to ggplot() maps:
```{r}
library(maps)
library(ggplot2)
