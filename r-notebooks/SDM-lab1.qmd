...
* Make sure you are in the sdm-labs project. Top right corner.
* Create a folder called `data` if you don't have one.

```{r}
here::i_am("r-notebooks/SDM-lab1.qmd")
